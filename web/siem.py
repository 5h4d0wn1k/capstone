...
from modules.collectors.syslog_collector import SyslogCollector
from modules.collectors.custom_collector import CustomLogCollector
...
class SIEM:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.defensive_tools = DefensiveTools(config)
        self.offensive_tools = OffensiveTools(config)

        # Initialize collectors
        self.windows_collector = WindowsEventCollector(config)
        self.syslog_collector = SyslogCollector(config)
        self.custom_collector = CustomLogCollector(config)
    ...
    def run(self, debug: bool = False) -> None:
        ...
        # Start web interface
        self.start_web_interface(debug)
    ...
    def start_web_interface(self, debug: bool = False) -> None:
        """Start web interface.
